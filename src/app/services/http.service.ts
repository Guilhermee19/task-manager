...
export interface BodyJson {
  [key: string]: string | string[] | number | boolean | BodyJson | BodyJson[];
}
...
export class HttpService {
  ...
  // private notifierService = inject(NotifierService);  // private snackbar: SnackbarService
  ...
  private handleError = (error: HttpErrorResponse) => {
    ...
    //   //   type: 'error',
    //   //   message: `Seu cadastro está em análise. Em caso de dúvida entrar em contato com sac@nip.imb.br`,
    //   // });
    // } else if (
    //   errorMessage !==
